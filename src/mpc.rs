...
/// See: [Return Value](https://tspiteri.gitlab.io/gmp-mpfr/mpc/GNU-MPC-Basics.html#return_002dvalue)
#[inline]
...
/// See: [`mpc_rnd_t`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/GNU-MPC-Basics.html#index-mpc_005frnd_005ft)
...
/// See: [Rounding Modes](https://tspiteri.gitlab.io/gmp-mpfr/mpc/GNU-MPC-Basics.html#Rounding-Modes)
...
/// See: [`mpc_t`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/GNU-MPC-Basics.html#index-mpc_005ft)
#[repr(C)]
...
extern "C" {
    ...
    /// See: [`mpc_init2`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005finit2)
    #[link_name = "mpc_init2"]
    pub fn init2(z: mpc_ptr, prec: mpfr::prec_t);
    /// See: [`mpc_init3`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005finit3)
    #[link_name = "mpc_init3"]
    pub fn init3(z: mpc_ptr, prec_r: mpfr::prec_t, prec_i: mpfr::prec_t);
    /// See: [`mpc_clear`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fclear)
    #[link_name = "mpc_clear"]
    pub fn clear(z: mpc_ptr);
    /// See: [`mpc_set_prec`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fset_005fprec)
    #[link_name = "mpc_set_prec"]
    pub fn set_prec(x: mpc_ptr, prec: mpfr::prec_t);
    /// See: [`mpc_get_prec`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fget_005fprec)
    ...
    /// See: [`mpc_set`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fset)
    #[link_name = "mpc_set"]
    pub fn set(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_set_ui`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fset_005fui)
    #[link_name = "mpc_set_ui"]
    pub fn set_ui(rop: mpc_ptr, op: c_ulong, rnd: rnd_t) -> c_int;
    /// See: [`mpc_set_si`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fset_005fsi)
    #[link_name = "mpc_set_si"]
    pub fn set_si(rop: mpc_ptr, op: c_long, rnd: rnd_t) -> c_int;
    /// See: [`mpc_set_d`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fset_005fd)
    #[link_name = "mpc_set_d"]
    pub fn set_d(rop: mpc_ptr, op: f64, rnd: rnd_t) -> c_int;
    /// See: [`mpc_set_z`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fset_005fz)
    #[link_name = "mpc_set_z"]
    pub fn set_z(rop: mpc_ptr, op: mpz_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_set_q`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fset_005fq)
    #[link_name = "mpc_set_q"]
    pub fn set_q(rop: mpc_ptr, op: mpq_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_set_f`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fset_005ff)
    #[link_name = "mpc_set_f"]
    pub fn set_f(rop: mpc_ptr, op: mpf_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_set_fr`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fset_005ffr)
    ...
    /// See: [`mpc_swap`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fswap)
    #[link_name = "mpc_swap"]
    ...
    /// See: [`mpc_cmp`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fcmp)
    #[link_name = "mpc_cmp"]
    pub fn cmp(op1: mpc_srcptr, op2: mpc_srcptr) -> c_int;
    /// See: [`mpc_cmp_si_si`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fcmp_005fsi_005fsi)
    #[link_name = "mpc_cmp_si_si"]
    pub fn cmp_si_si(op1: mpc_srcptr, op2r: c_long, op2i: c_long) -> c_int;
}
/// See: [`mpc_cmp_si`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fcmp_005fsi)
#[inline]
...
extern "C" {
    ...
    /// See: [`mpc_real`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005freal)
    #[link_name = "mpc_real"]
    pub fn real(rop: mpfr_ptr, arg2: mpc_srcptr, rnd: mpfr::rnd_t) -> c_int;
    /// See: [`mpc_imag`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fimag)
    #[link_name = "mpc_imag"]
    pub fn imag(rop: mpfr_ptr, arg2: mpc_srcptr, rnd: mpfr::rnd_t) -> c_int;
}
/// See: [`mpc_realref`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005frealref)
#[inline]
...
extern "C" {
    ...
    /// See: [`mpc_proj`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fproj)
    #[link_name = "mpc_proj"]
...
extern "C" {
    ...
    /// See: [`mpc_abs`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fabs)
    #[link_name = "mpc_abs"]
    pub fn abs(rop: mpfr_ptr, op: mpc_srcptr, rnd: mpfr::rnd_t) -> c_int;
    /// See: [`mpc_norm`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fnorm)
    #[link_name = "mpc_norm"]
    ...
    /// See: [`mpc_sqrt`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fsqrt)
    #[link_name = "mpc_sqrt"]
    ...
    /// See: [`mpc_log`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005flog)
    #[link_name = "mpc_log"]
    pub fn log(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_log10`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005flog10)
    #[link_name = "mpc_log10"]
    pub fn log10(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;

    // Trigonometric Functions

    /// See: [`mpc_sin`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fsin)
    #[link_name = "mpc_sin"]
    pub fn sin(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_cos`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fcos)
    #[link_name = "mpc_cos"]
    ...
    /// See: [`mpc_sinh`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fsinh)
    #[link_name = "mpc_sinh"]
    pub fn sinh(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_cosh`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fcosh)
    #[link_name = "mpc_cosh"]
    pub fn cosh(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_tanh`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005ftanh)
    #[link_name = "mpc_tanh"]
    pub fn tanh(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_asin`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fasin)
    #[link_name = "mpc_asin"]
    pub fn asin(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_acos`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005facos)
    #[link_name = "mpc_acos"]
    pub fn acos(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_atan`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fatan)
    #[link_name = "mpc_atan"]
    pub fn atan(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_asinh`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fasinh)
    #[link_name = "mpc_asinh"]
    pub fn asinh(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_acosh`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005facosh)
    #[link_name = "mpc_acosh"]
    pub fn acosh(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;
    /// See: [`mpc_atanh`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fatanh)
    #[link_name = "mpc_atanh"]
    pub fn atanh(rop: mpc_ptr, op: mpc_srcptr, rnd: rnd_t) -> c_int;

    // Miscellaneous Functions

    /// See: [`mpc_urandom`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005furandom)
    #[link_name = "mpc_urandom"]
    pub fn urandom(rop: mpc_ptr, state: randstate_ptr) -> c_int;
    /// See: [`mpc_get_version`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-mpc_005fget_005fversion)
...
/// See: [`MPC_VERSION_PATCHLEVEL`](https://tspiteri.gitlab.io/gmp-mpfr/mpc/Complex-Functions.html#index-MPC_005fVERSION_005fPATCHLEVEL)
